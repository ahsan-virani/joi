  ...
  ip(ipOptions) {
    ...
    if (ipOptions.version) {
      ...
      for (let i = 0; i < ipOptions.version.length; ++i) {
        ...
        Hoek.assert(Ip.versions[version], 'version at position ' + i + ' must be one of ' + Object.keys(Ip.versions)
          .join(', '));
  ...
  guid(guidOptions) {
    ...
    if (guidOptions && guidOptions.version) {
      ...
      for (let i = 0; i < guidOptions.version.length; ++i) {
        ...
        Hoek.assert(versionNumber, 'version at position ' + i + ' must be one of ' + Object.keys(internals.guidVersions)
          .join(', '));
